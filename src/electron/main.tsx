        ...
        submenu: [
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/kiwihealthcare-network/kiwi-blockchain/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/kiwihealthcare-network/kiwi-blockchain/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/kiwihealthcare-network/kiwi-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/kiwihealthcare-network/kiwi-blockchain/blob/master/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/kiwihealthcare-network/kiwi-blockchain/issues',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal('https://keybase.io/team/kiwi_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/KiwiNetwork_EN');
            },
          },
        ],
      },
