...
global.daemon_rpc_ws = `wss://${self_hostname}:10015`;
  ...
  try {
    ...
    const config_root_dir =
      'CHIA_ROOT' in process.env
        ...
        : path.join(os.homedir(), '.kiwi', version);
    ...
    const daemon_port = lodash.get(config, 'ui.daemon_port', 10015); // jshint ignore:line
